...
# ================== FUNGSI BACA GITHUB (FIXED: ANTI-ENCODING ERROR) ==================
def ambil_data_dari_github():
    try:
        ...
        # PENYELESAIAN JALAN SELAMAT:
        # Ambil content Base64 asal daripada GitHub, decode sendiri ke bytes, kemudian decode ke utf-8 string.
        # Ini mengelakkan ralat 'unsupported encoding: none' secara total.
