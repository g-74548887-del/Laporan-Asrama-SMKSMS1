...
with col1:
    with st.container(height=650):
        # Sediakan 5 lajur utama
        lajur = st.columns(5)
        
        # Kirakan berapa baris diperlukan untuk membahagikan tarikh sama rata secara menegak
        total_items = len(all_dates)
        per_col = (total_items + 4) // 5  # Pembundaran ke atas
        
        # Susun tarikh secara menegak mengikut turutan kalendar yang betul
