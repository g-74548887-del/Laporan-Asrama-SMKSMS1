...
def extract(text):
    ...
    for line in text.split("\n"):
        ...
        # Hanya ambil line yang ada perkataan HAID
...
with col2:
    ...
    if not st.session_state.haid:

        st.info("Tiada murid")

    else:

        for i, m in enumerate(st.session_state.haid):
