...
def papar_borang(date_key):
    ...
    # CSS mikro untuk paksa butang kekal sebaris di skrin kecil telefon
    st.markdown(
        """
        <style>
    ...
    with st.container(height=350):
        for m in MURID:
            ...
            # Kita pecah pembahagi kepada 2 lajur sahaja (Lajur Nama luas, Lajur Butang digabungkan)
            ...
            with col_butang:
                # Membina sub-lajur mikro yang rapat dalam lajur butang supaya tidak pecah ke bawah
